...
## Measuring of over 22 Acoustic Parameters in the sound files
```{r,echo=TRUE}
...
## Conclusion
 ...
 + Using the Freq_range as a band filter generates over 22 acoustic parameters for the remaining 35 .wav files
...
FREQUENCY_ANALYSIS_OF_SOUNDS_OF_ANIMALS%20(1).pdf
